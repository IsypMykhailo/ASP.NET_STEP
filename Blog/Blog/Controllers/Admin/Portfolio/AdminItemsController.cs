...
namespace Blog.Controllers.Admin.Portfolio
{
    public class AdminItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Slug,CategoryId")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Slug,CategoryId")] Item item)
        {
            if (id != item.Id)
            {
                return NotFound();
